   ...
   <Paper
    ...
    <Box sx={{ minWidth: 120,mb: 2 }}>
      <FormControl fullWidth size='small'>
        ...
        CSS Framework<Select labelId="demo-simple-select-label" id="demo-simple-select">
     ...
     <Box sx={{ minWidth: 120,mb: 2 }}>
      <FormControl fullWidth size='small'>
        <InputLabel id="demo-simple-select-label"></InputLabel>
       Colour Scheme<Select labelId="demo-simple-select-label" id="demo-simple-select">
     ...
     <Box sx={{ minWidth: 120,mb:2}} >
      <FormControl fullWidth size='small' >
        <InputLabel id="demo-simple-select-label"></InputLabel>
        Component Size<Select labelId="demo-simple-select-label" id="demo-simple-select" >
     ...
     <Box sx={{ minWidth: 120,mb:2,mt:2}}>
      <FormControl fullWidth size='small'>
        <InputLabel id="demo-simple-select-label"></InputLabel>
        Border Radius<Select labelId="demo-simple-select-label" id="demo-simple-select">
